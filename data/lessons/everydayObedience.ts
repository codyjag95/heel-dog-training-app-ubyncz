...
export const everydayObedienceLessons: Lesson[] = [
  {
    id: 'eo_1',
    title: 'Name Recognition',
    description: 'Teach your dog to respond to their name enthusiastically',
    duration: 5,
    difficulty: 1,
    isPremium: false,
    steps: [
  ...
  },
  {
    id: 'eo_4',
    title: 'Stay (Duration)',
    description: 'Build duration - keeping position for longer',
    duration: 10,
    difficulty: 2,
    isPremium: false,
    steps: [
  ...
  },
  {
    id: 'eo_5',
    title: 'Stay (Distance)',
    description: 'Adding distance while maintaining the stay',
    duration: 10,
    difficulty: 3,
    isPremium: false,
    steps: [
  ...
  },
  {
    id: 'eo_6',
    title: 'Leave It',
    description: 'Teach your dog to ignore tempting items',
    duration: 8,
    difficulty: 2,
    isPremium: false,
    steps: [
      ...
      'Real-world practice: use "leave it" for things on the ground during walks, food dropped in the kitchen, or interesting garbage on the sidewalk'
    ],
    tips: [
  ...
  },
  {
    id: 'eo_7',
    title: 'Wait',
    description: 'Temporary pause before moving forward',
    duration: 6,
    difficulty: 2,
    isPremium: false,
    steps: [
  ...
  },
  {
    id: 'eo_8',
    title: 'Drop It',
    description: 'Get your dog to release items from their mouth',
    duration: 7,
    difficulty: 2,
    isPremium: false,
    steps: [
    ...
    tips: [
      'Never chase your dog when they have something. Chasing turns it into a game and teaches them to run away with stolen items',
      'If they won\'t trade, your treat isn\'t good enough. Level up to real meat, peanut butter, or whatever your dog goes crazy for',
      'For mouthy breeds (retrievers, Aussies), this is especially important since they naturally carry things around. Turn it into a cooperative game, not a power struggle',
      'If they resource guard (growl, stiffen, snap when you approach their items), skip this lesson and consult a professional trainer. Resource guarding needs specialized help'
    ]
  },
  {
    id: 'eo_9',
    title: 'Go to Bed/Crate',
    description: 'Send your dog to their designated spot',
    duration: 10,
    difficulty: 3,
    isPremium: false,
    steps: [
  ...
  },
  {
    id: 'eo_10',
    title: 'Shake/Paw',
    description: 'A fun trick that also builds engagement',
    duration: 5,
    difficulty: 1,
    isPremium: false,
    steps: [
  ...
  // --- PREMIUM LESSONS ---
  {
    ...
    description: 'Teaching your dog to touch your hand with their nose',
    duration: 5,
    difficulty: 1,
    isPremium: true,
    steps: [
      ...
      'Practice using touch to move your dog around: guide them through doorways, into heel position, onto a scale at the vet, or away from distractions. Touch replaces physical manipulation with willing cooperation',
      'Advanced: teach them to touch other objects (a target stick, a post-it note on the wall). This opens up trick training possibilities like closing doors, turning off lights, and more'
    ],
    tips: [
  ...
  },
  {
    id: 'eo_12',
    title: 'Heel Position',
    description: 'Teaching your dog to walk precisely at your side',
    duration: 12,
    difficulty: 3,
    isPremium: true,
    steps: [
  ...
  {
    id: 'eo_13',
    title: 'Place (Advanced)',
    description: 'Advanced "place" command with duration and distractions',
    duration: 15,
    difficulty: 4,
    isPremium: true,
    steps: [
      ...
      'Practice the doorbell scenario: someone knocks or rings, you say "place," your dog goes to their spot and stays while you answer the door. This replaces door-charging with a trained behavior',
      'Build to the "dinner party place": your dog on place while you eat, while guests are over, or while kids are playing. Start with short durations (2 min) and work up to 15-20 minutes with a chew',
