...
export default function PremiumScreen() {
  ...
  const getBenefits = () => {
    const base = [
      ...
      { icon: 'lock-open-outline', text: `Full access to 175+ lessons. Every category, every skill, from day one.` },
      { icon: 'people-outline', text: `Multi-dog household? One subscription covers up to 5 dogs, each with their own plan and progress.` },
  ...
  return (
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        {/* Plans. Monthly carries the trial, annual anchors the value */}
        <View style={styles.plansContainer}>
          ...
          <TouchableOpacity style={[styles.planCard, selectedPlan === 'annual' && styles.planCardSelected]} onPress={() => setSelectedPlan('annual')} activeOpacity={0.7}>
            <View style={[styles.planBadge, { backgroundColor: '#333333' }]}><Text style={styles.planBadgeText}>SAVE 42%</Text></View>
        ...
        <Text style={styles.trialNote}>
          {selectedPlan === 'monthly' ? `Nothing due today. ${monthlyPrice}/month after your free 3 days.` : `${annualPrice} billed once a year. No surprises.`}
